//Lay user theo email
//loi scheded lulist cua user
//truy cap vao tung phan tu cua danh sach
//ve item ---> data + html
var current_user_email = localStorage.getItem('current_loggedin_user');
var current_loggedin_user = JSON.parse(localStorage.getItem(current_user_email));
